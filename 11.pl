...
my $input = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
# I wont type that every time
sub f {
  my ($x1, $y1, $x2, $y2, $x3, $y3, $x4, $y4) = @_;
  my $curr = $matrix[$x1][$y1] * $matrix[$x2][$y2] * $matrix[$x3][$y3] * $matrix[$x4][$y4];
  $max = $curr if ($curr > $max);
}

for my $y (0..@matrix-1) {
  for my $x (0..@matrix-1) {
    # horizontal/vertical/right diag/left diag
    f($x, $y, $x+1, $y, $x+2, $y, $x+3, $y) if ($x+3 < @matrix);
    f($x ,$y, $x, $y+1, $x, $y+2, $x, $y+3) if ($y+3 < @matrix);
    f($x ,$y, $x+1, $y+1, $x+2, $y+2, $x+3, $y+3) if ($x+3 < @matrix && $y+3 < @matrix);
    f($x ,$y, $x+1, $y-1, $x+2, $y-2, $x+3, $y-3) if ($x+3 < @matrix && $y > 2);
  }
}
print "$max\n";
